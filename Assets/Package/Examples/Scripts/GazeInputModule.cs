...
namespace Gaze.InputSystem
{
    ...
    public class GazeInputModule : PointerInputModule
    {
        ...
        public override bool ShouldActivateModule()
        {
            ...
            shouldActivate |= InputManager.Instance.GetButtonDown(m_SubmitButton);
            shouldActivate |= InputManager.Instance.GetButtonDown(m_CancelButton);
        ...
        protected bool SendSubmitEventToSelectedObject()
        {
            ...
            if (InputManager.Instance.GetButtonDown(m_SubmitButton))
                ExecuteEvents.Execute(eventSystem.currentSelectedGameObject, data, ExecuteEvents.submitHandler);

            if (InputManager.Instance.GetButtonDown(m_CancelButton))
        ...
        private Vector2 GetRawMoveVector()
        {
            ...
            if (InputManager.Instance.GetButtonDown(m_HorizontalAxis))
            {
                if (move.x < 0)
                    move.x = -1f;
                if (move.x > 0)
            ...
            if (InputManager.Instance.GetButtonDown(m_VerticalAxis))
            {
                if (move.y < 0)
                    move.y = -1f;
                if (move.y > 0)
